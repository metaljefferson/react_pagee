          ...
          <div className="accordion  d-lg-flex" id="accordion">
            ...
            <div>
              <h2 className="accordion-header" id="eleven">
                ...
                >
                  <img className="img-fluid" src={images["Telefone-Banco-Pan.jpg"]} width={300}></img>
                </button>
              </h2>
              <div
                id="collapse-eleven"
            ...
            <div>
              <h2 className="accordion-header" id="twelve">
                ...
                >
                  <img className="img-fluid" src={images["ole.png"]} width={225}></img>
                </button>
              </h2>
              <div
                id="collapse-twelve"
          ...
          <div className="accordion  d-lg-flex" id="accordion">
            ...
            <div>
              <h2 className="accordion-header" id="fourteen">
                ...
                >
                  <img className="img-fluid" src={images["f653224b37e34dfa45e4acc661dffbf4.png"]} width={225}></img>
                </button>
              </h2>
              <div
            ...
            <div>
              <h2 className="accordion-header" id="fifteen">
                ...
                >
                  <img
                    className="img-fluid"
                    src={images["banco-cetelem-1-1024x576.png"]} width={400}
                  ></img>
                </button>
              </h2>
              <div
            ...
            <div>
              <h2 className="accordion-header" id="sixteen">
                ...
                >
                  <img className="img-fluid" src={images["c6-bank.png"]} width={"400"}></img>
                </button>
              </h2>
              <div
                id="collapse-sixteen"
            ...
            <div>
              <h2 className="accordion-header" id="seventeen">
                ...
                >
                  <img className="img-fluid" src={images["256x256bb.jpg"]} width={"225"}></img>
                </button>
              </h2>
              <div
            ...
            <div>
              <h2 className="accordion-header" id="eighteen">
                ...
                >
                  <img className="img-fluid" src={images["bancobrb.jpg"]} width={"225"}></img>
                </button>
              </h2>
              <div
